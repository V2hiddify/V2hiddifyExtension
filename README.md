...
[![inlang status badge](https://inlang.com/badge?url=github.com/V2hiddify/V2hiddifyExtension)](https://inlang.com/editor/github.com/V2hiddify/V2hiddifyExtension?ref=badge)
</div>

Improve existing languages or add new ones by manually editing the JSON files located in `/hiddify_extension/translations` or by using the [Inlang online editor](https://inlang.com/editor/github.com/V2hiddify/V2hiddifyExtension).
