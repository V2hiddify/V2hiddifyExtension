...
func (e *V2hiddifyExtension) GetUI() ui.Form {
...
func (e *V2hiddifyExtension) setFormData(data map[string]string) error {
...
func (e *V2hiddifyExtension) getRunningUI() ui.Form {

	return ui.Form{
		Title:       "V2hiddifyExtension",
		Description: "Awesome Extension v2hiddifyextension created by V2hiddify",
		Fields: [][]ui.FormField{
			{{
...
func (e *V2hiddifyExtension) getStoppedUI() ui.Form {
	// Inital page
	return ui.Form{
		Title:       "V2hiddifyExtension",
		Description: "Awesome Extension v2hiddifyextension created by V2hiddify",
...
func (e *V2hiddifyExtension) addAndUpdateConsole(message ...any) {
